...
"Feed not found: either the website does not provide a feed or blocks access. To rule out blocking, try to download the feed on your server's command line using curl: curl " => "フィードが見つかりません: サイトがフィードを提供していないか、アクセスがブロックされています。ブロッキングを取り除くために、サーバー上でcurlコマンド を実行してフィードをダウンロードしてみてください: curl",
...
"Internal server error! Please check your data/owncloud.log file for additional information!" => "インターナルサーバーエラー！追加情報 はdata/owncloud.logを確認してください！",
