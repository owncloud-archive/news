...
"Disable this if you run a custom updater such as the Python updater included in the app" => "Schakel dit uit als u een maatwerk updater gebruikt, zoals de Python updater bij deze app",
"Purge interval" => "Reinigingsinterval",
"Minimum amount of seconds after deleted feeds and folders are removed from the database; values below 60 seconds are ignored" => "Minimum aantal seconden waarna verwijderde feeds en mappen worden verwijderd uit de database; waarden onder 60 seconden worden genegeerd.",
