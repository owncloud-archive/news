...
"Required credentials for feed were either missing or incorrect" => "Απαιτούμενα διαπιστευτήρια για την ροή είτε λείπουν ή είναι λανθασμένα ",
"Forbidden to access feed" => "Απαγορεύεται η πρόσβαση στην ροή",
"Certificate error: A problem occurred somewhere in the SSL/TLS handshake. Could be certificates (file formats, paths, permissions), passwords, and others." => "Σφάλμα πιστοποιητικού: Παρουσιάστηκε κάποιο πρόβλημα στη χειραψία SSL / TLS. Θα μπορούσαν να είναι πιστοποιητικά (μορφές αρχείων, διαδρομές, δικαιώματα), κωδικοί πρόσβασης και άλλα.",
"Certificate error: The remote server's SSL certificate or SSH md5 fingerprint was deemed not OK." => "Σφάλμα πιστοποίησης: Το πιστοποιητικό SSL του απομακρυσμένου διακομιστή ή το αποτύπωμα md5 SSH κρίνεται ότι δεν ήταν εντάξει.",
"Certificate error: Problem with the local client certificate." => "Σφάλμα πιστοποίησης: Πρόβλημα με την πιστοποίηση του τοπικού πελάτη.",
"Certificate error: Couldn't use specified cipher." => "Σφάλμα πιστοποιητικού: Αδυναμία χρήσης καθορισμένης κρυπτογράφησης.",
"Certificate error: Peer certificate cannot be authenticated with known CA certificates." => "Certificate error: Το ομότιμο πιστοποιητικό δεν μπορεί να ταυτοποιηθεί με τα γνώριμα πιστοποιητικά CA ",
"Certificate error: Requested FTP SSL level failed." => "Certificate error: Η αίτηση επιπέδου FTP SSL απέτυχε.",
"Certificate error: Initiating the SSL Engine failed." => "Σφάλμα πιστοποιητικού: Η αρχικοποίηση της μηχανής του SSL απέτυχε.",
"Certificate error: Problem with reading the SSL CA cert (path? access rights?)" => "Σφάλμα πιστοποίησης: Πρόβλημα με την ανάγνωση του πιστοποιητικού SSL CA (διαδρομή? δικαιώματα πρόσβασης?)",
"Certificate error: Issuer check failed" => "Σφάλμα πιστοποιητικού: Ο έλεγχος του χρήστη που έχει πρόβλημα απέτυχε",
"Unknown SSL certificate error!" => "Άγνωστο σφάλμα πιστοποιητικών SSL!",
...
"For more information check the Wiki" => "Για περισσότερες πληροφορίες δείτε το Wiki",
"Saved" => "Αποθηκεύτηκαν",
"Download" => "Λήψη",
"Close" => "Κλείσιμο",
"Ajax or Web cron mode detected! Your feeds will not be updated!" => "Ανιχνεύτηκε Ajax ή κατάσταση Web cron! Οι ροές σας δεν θα ενημερωθούν!",
"How to set up the operating system cron" => "Πώς να ρυθμίσετε την υπηρεσία cron του λειτουργικού συστήματος",
"Install and set up a faster parallel updater that uses the News app's update API" => "Εγκατάσταση και ρύθμιση ταχύτερης παράλληλης ενημέρωσης με χρήση της ΑΡΙ ενημερώσεων της εφαρμογής Νέων",
"filter" => "φίλτρο",
"Language" => "Γλώσσα",
"Subscribe" => "Συνδρομή",
"Got more awesome feeds? Share them with us!" => "Έχετε πιο καταπληκτικές ροές; Μοιραστείτε τα μαζί μας!",
...
"Create" => "Δημιουργία",
"Explore" => "Εξερεύνηση",
"Update failed more than 50 times" => "Η ενημέρωση απέτυχε πάνω από 50 φορές",
...
"Error when importing: OPML is does neither contain feeds nor folders" => "Σφάλμα κατά την εισαγωγή: το OPML δεν περιέχει ροές ούτε φακέλους",
